        ...
        <div className="Center">
          ...
          >
            <div className="Container-hobbies">
              ...
              <p className="Text">
                I've been riding mtb (downhill and enduro) since I was a child!
                Cycling is my favorite sport, I even did trials for a while and
                participated in some downhill races for a couple of years.
              </p>
            </div>
          </AnimatedOnScroll>
          ...
          >
            <div className="Container-hobbies">
              ...
              <p className="Text">
                I've always liked classic vehicles. I like the way they sound
                and the sensation of driving it as if I were in another time.
                I'm a proud owner of a 1979 Mercedes that has always been in the
                family and some classic bikes.
              </p>
            </div>
          </AnimatedOnScroll>
          ...
          >
            <div className="Container-hobbies">
              ...
              <p className="Text">
                Always available for a hike, training hard to improve my marks
                and endurance. I love the sensation of peace and adventure that
                the mountains bring. Spending the night in the pyrenees, without
                tent, looking at the stars, is the best definition of a plan for
                me.
              </p>
            </div>
          </AnimatedOnScroll>
