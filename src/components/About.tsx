...
function About({ handleProjectsClick }: Props) {
  ...
  return <div className='About mw' >
    ...
    <div className='About_container'>
      ...
      <AnimationOnScroll className='Center' animateIn="animate__slideInRight" offset={400} duration={1} animateOnce>
      ...
      <AnimationOnScroll className='Center' animateIn="animate__slideInLeft" offset={300} duration={1} animateOnce>
        <div className='Container-left'>
      ...
      <AnimationOnScroll className='Center' animateIn="animate__slideInRight" offset={300} duration={1} animateOnce>
        <div className='Container-right Solape'>
      ...
      <AnimationOnScroll className='Center' animateIn="animate__slideInRight" offset={300} duration={1} animateOnce>
        <div className='Container-right Solape'>
          ...
          <iframe width="100%" height='330' src="https://www.youtube.com/embed/iS7Cr3piWSQ" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" ></iframe>
      ...
      <AnimationOnScroll className='Center' animateIn="animate__slideInRight" offset={300} duration={1} animateOnce>
        ...
        <div className='Container-right-2'>
          <button className='Projects_button' onClick={handleProjectsClick}>Go to Projects</button>
        </div>
      </AnimationOnScroll>
